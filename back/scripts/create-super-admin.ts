...
async function main() {
  ...
  console.log("📦 Creando features por defecto...");
  ...
  console.log(`   ✅ ${defaultFeatures.length} features creadas`);

  // Seed de planes por defecto
  console.log("\n📋 Creando planes por defecto...");
  ...
  console.log(`   ✅ ${defaultPlans.length} planes creados\n`);
}
